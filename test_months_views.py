...
from agent_entree_finopsrag import update_powerbi_views_for_months
...
def main() -> None:
    ...
    print("=== STEP 1: update_powerbi_views_for_months ===")
    ok = update_powerbi_views_for_months(selection)
    ...
    print("\n=== TOP SERVICE ===")
    top_service = (
        service_df.groupby("service", as_index=False)["actual_cost_usd"]
        .sum()
